...
Alter Table "T_DATESPLANNINGS" add Foreign Key ("IDX_PLANNING") references "T_PLANNINGS" ("IDX_PLANNING") on update no action on delete no action ;
...
INSERT INTO T_ANNEESSCOLAIRES (IDX_ANNEESCOLAIRE, ANNEEANNEESCOLAIRE) VALUES
  (1, 2021),
  (2, 2022),
  (3, 2023);
INSERT INTO T_EPHEMERIDES (IDX_EPHEMERIDE, IDX_ANNEESCOLAIRE, INTITULEEPHEMERIDE, DATEDEBUTEPHEMERIDE, DATEFINEPHEMERIDE) VALUES
  (1, 1, 'Fête de la Communauté française', '2021-09-27', '2021-09-27'),
  (2, 2, 'Fête de la Communauté française', '2022-09-27', '2022-09-27');
INSERT INTO T_ETAPES (IDX_ETAPE, NOMETAPE, ADRESSEETAPE, PRINTEDETAPE) VALUES
  (1, 'CERIA', 'Avenue Emile Gryson 1 - 1070 Anderlecht', FALSE),
  (2, 'Redouté', 'Avenue Marius Renard 1 - 1070 Anderlecht', FALSE),
  (4, 'Herlin', 'Rue de Dilbeek 1 - 1080 Berchem-Sainte-Agathe', FALSE),
  (6, 'Walibi', 'Bd de l''Europe 100 - 1300 Wavre', TRUE),
  (5, 'Bon Air', 'Rue du Pommier 101 - 1070 Anderlecht', FALSE),
  (3, 'Piscine', 'Rue des Grives 51 - 1070 Anderlecht', FALSE);
INSERT INTO T_TRAJETS (IDX_TRAJET, IDX_ETAPEDEPART, IDX_ETAPEARRIVEE, TEMPSTRAJET, KMTRAJET, NOMTRAJET) VALUES
  (1, 1, 2, '00:10:00', 5.09999990463257, 'CERIA-Redouta'),
  (2, 2, 1, '00:10:00', 5, 'Redoute-CERIA'),
  (3, 5, 2, '00:07:00', 5.80000019073486, 'Bon Air-Redouta'),
  (4, 4, 3, '00:16:00', 10.3000001907349, 'Herlin-Piscine');
INSERT INTO T_VEHICULES (IDX_VEHICULE, MARQUEVEHICULE, MODELEVEHICULE, NOMVEHICULE, PLACESVEHICULE) VALUES
  (1, 'Mercedes', 'A', 'GEO', 61);
