<?php
/**
 * This is the ViewTrajetTable class for ViewTrajetTable service.
 * 
 * @package   module/Transport/src/Model/ViewTrajetTable.php
 * @version   1.0
...
class ViewTrajetTable
{
  ...
  private function fetchPaginatedResults()
  {
    ...
    // Create a new result set based on the ViewTrajet entity:
  ...
  //
  public function getViewTrajet($id)
  {
  ...
  public function findOneById(int $id)
  {
    ...
    $viewTrajet = $this->findOneBy(['IDX_TRAJET' => (int) $id]);
    return $viewTrajet;
  }
  ...
  public function findOneByNom($nom)
  {
    ...
    $viewTrajet = $this->findOneBy(['NOMTRAJET' => $nom]);
    return $viewTrajet;
  }
  ...
  public function findOneByRecord(array $data)
  {
    ...
    unset($data["IDX_TRAJET"]);
    $viewTrajet = $this->findOneBy($data);
