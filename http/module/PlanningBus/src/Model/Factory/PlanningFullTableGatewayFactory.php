<?php
/**
 * @package   : module/PlanningBus/src/Service/Factory/PlanningFullTableGatewayFactory.php
 *
...
use PlanningBus\Model\PlanningFull;


/*
 * 
 */
class PlanningFullTableGatewayFactory implements FactoryInterface
{
  ...
  public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
  {
    ...
    $resultSetPrototype->setArrayObjectPrototype(new PlanningFull());
    return new TableGateway('V_PLANNINGS-FULL', $dbAdapter, null, $resultSetPrototype);
  }
}
