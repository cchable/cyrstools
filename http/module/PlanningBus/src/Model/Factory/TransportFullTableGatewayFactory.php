<?php
/**
 * @package   : module/PlanningBus/src/Service/Factory/TransportFullTableGatewayFactory.php
 *
...
use PlanningBus\Model\TransportFull;


/*
 * 
 */
class TransportFullTableGatewayFactory implements FactoryInterface
{
  ...
  public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
  {
    ...
    $resultSetPrototype->setArrayObjectPrototype(new TransportFull());
    return new TableGateway('V_TRANSPORTS-FULL', $dbAdapter, null, $resultSetPrototype);
  }
}
