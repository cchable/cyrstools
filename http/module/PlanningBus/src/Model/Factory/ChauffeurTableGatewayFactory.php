<?php
/**
 * @package   : module/PlanningBus/src/Service/Factory/ChauffeurTableGatewayFactory.php
 *
 ...
 * 
 */
class ChauffeurTableGatewayFactory implements FactoryInterface
{
  ...
  public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
  {
    ...
    return new TableGateway('T_CHAUFFEURS', $dbAdapter, null, $resultSetPrototype);
  }
}
