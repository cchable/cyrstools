<?php
/**
 * @package   : module/PlanningBus/src/Service/Factory/TrajetFullTableGatewayFactory.php
 *
...
use PlanningBus\Model\TrajetFull;


/*
 * 
 */
class TrajetFullTableGatewayFactory implements FactoryInterface
{
  ...
  public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
  {
    ...
    $resultSetPrototype->setArrayObjectPrototype(new TrajetFull());
    return new TableGateway('V_TRAJETS-FULL', $dbAdapter, null, $resultSetPrototype);
  }
}
