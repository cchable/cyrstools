<?php
/**
 * @package   : module/PlanningBus/src/Service/Factory/EphemerideFullTableGatewayFactory.php
 *
...
use PlanningBus\Model\EphemerideFull;


/*
 * 
 */
class EphemerideFullTableGatewayFactory implements FactoryInterface
{
  ...
  public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
  {
    ...
    $resultSetPrototype->setArrayObjectPrototype(new EphemerideFull());
    return new TableGateway('V_EPHEMERIDES-FULL', $dbAdapter, null, $resultSetPrototype);
  }
}
