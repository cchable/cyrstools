<?php
/**
 * @package   : module/PlanningBus/src/Model/AnneeScolaireTable.php
 *
 * @purpose   :
 * 
 * 
...
class AnneeScolaireTable
{
  ...
  public function saveAnneeScolaire(AnneeScolaire $anneeScolaire)
  {
    ...
    $data = $anneeScolaire->getArrayCopy();
    $id = (int) $anneeScolaire->getId();

    if ($id === 0) {
      $result = $this->tableGateway->insert($data);
      $anneeScolaire = $this->findOneByAnneeScolaire($anneeScolaire->getAnneeScolaire());
  ...
  //  
  public function findOneByAnneeScolaire(int $annee) 
  {
    
    $anneeScolaire = $this->findOneBy(['ANNEEANNEESCOLAIRE' => $annee]);
    return $anneeScolaire;
  }  
}